...
$app->post('/api/500px/addPhotosAfter', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','token','tokenSecret','userId','galleryId','addAfter','photos']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret','token'=>'token','tokenSecret'=>'tokenSecret','userId'=>'userId','galleryId'=>'galleryId','addAfter'=>'addAfter','photos'=>'photos'];
    $optionalParams = [];
    $bodyParams = [
       'json' => ['photos','addAfter']
    ];
