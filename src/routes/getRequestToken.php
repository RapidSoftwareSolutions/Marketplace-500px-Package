...
$app->post('/api/500px/getRequestToken', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret'];
    $optionalParams = [];
    $bodyParams = [
       'form_params' => ['']
    ];
    ...
    $query_str = "https://api.500px.com/v1/oauth/request_token";
