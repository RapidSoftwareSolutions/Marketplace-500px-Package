...
$app->post('/api/500px/searchPhotosByTag', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','token','tokenSecret','tag']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret','token'=>'token','tokenSecret'=>'tokenSecret','tag'=>'tag'];
    ...
    $bodyParams = [
       'query' => ['license_type','image_size','user_id','tags','rpp','page','exclude_nude','exclude','was_featured_type','tag','only', "sort"]
    ];
