...
$app->post('/api/500px/listUserFollowers', function ($request, $response) {
    ...
    $optionalParams = ['page'=>'page','perPage'=>'rpp'];
    $bodyParams = [
       'query' => ['page','rpp']
    ];
    ...
    $query_str = "https://api.500px.com/v1/users/{$data['userId']}/followers";
