...
$app->post('/api/500px/searchUsers', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','token','tokenSecret','term']);
    ...
    $query_str = "https://api.500px.com/v1/users/search";
