...
$app->post('/api/500px/addPhotosBefore', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','token','tokenSecret','userId','galleryId','addBefore','photos']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret','token'=>'token','tokenSecret'=>'tokenSecret','userId'=>'userId','galleryId'=>'galleryId','addBefore'=>'addBefore','photos'=>'photos'];
    $optionalParams = [];
    $bodyParams = [
       'json' => ['photos','addBefore']
    ];
