...
$app->post('/api/500px/removePhotos', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','token','tokenSecret','userId','galleryId','photos']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret','token'=>'token','tokenSecret'=>'tokenSecret','userId'=>'userId','galleryId'=>'galleryId','photos'=>'photos'];
    $optionalParams = [];
    $bodyParams = [
       'json' => ['photos']
    ];
