...
$app->post('/api/500px/getSinglePhoto', function ($request, $response) {
    ...
    $optionalParams = ['imageSize'=>'image_size','comments'=>'comments','commentsPage'=>'comments_page','tags'=>'tags'];
    $bodyParams = [
       'query' => ['tags','comments_page','comments','image_size']
    ];
