...
$app->post('/api/500px/deleteTags', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','token','tokenSecret','photoId','tags']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret','token'=>'token','tokenSecret'=>'tokenSecret','photoId'=>'photoId','tags'=>'tags'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['tags']
    ];
    ...
    $query_str = "https://api.500px.com/v1/photos/{$data['photoId']}/tags";
