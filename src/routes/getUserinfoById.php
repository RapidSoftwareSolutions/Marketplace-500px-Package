...
$app->post('/api/500px/getUserinfoById', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'apiKey','apiSecret'=>'apiSecret','token'=>'token','tokenSecret'=>'tokenSecret','userId'=>'id'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['id']
    ];
