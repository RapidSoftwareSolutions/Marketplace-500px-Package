...
$app->post('/api/500px/addComment', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'token', 'tokenSecret', 'photoId', 'body']);
    ...
    $requiredParams = ['apiKey' => 'apiKey', 'apiSecret' => 'apiSecret', 'token' => 'token', 'tokenSecret' => 'tokenSecret', 'photoId' => 'photoId', 'body' => 'body'];
    $optionalParams = [];
    $bodyParams = [
        'form_params' => ['body']
    ];
